...
function valLetras(datos) {
    ...
    if (datos.id == 'nombres') {
        ...
        if ((n >= 65 && n <= 90) || (n >= 97 && n <= 122) || n == 32 || n == 225 || n == 233 || n == 237 || n == 243 || n == 250 || n == 193 || n == 201 || n == 205 || n == 211 || n == 218) {
            ...
            document.getElementById('mensajeNombres').innerHTML = '<br>Solo se permiten letras'
        }
        ...
        if ((n >= 65 && n <= 90) || (n >= 97 && n <= 122) || n == 32 || n == 225 || n == 233 || n == 237 || n == 243 || n == 250 || n == 193 || n == 201 || n == 205 || n == 211 || n == 218) {
            ...
            document.getElementById('mensajeApellidos').innerHTML = '<br>Solo se permiten letras'
...
function valNumeros(datos) {
    ...
    if (datos.id == 'telefono') {
        ...
        if (n >= 48 && n <= 57) {
            ...
            document.getElementById('mensajeTelefono').innerHTML = 'Solo se admiten numeros'
        }
    }
}
